    ...
    while (!datos_completos){
        ...
        if (!datos_completos){
            if (!caracter_valido) {
                ...
                printf("\n************************** "CYAN"MENU DE INICIO"BLANCO" **************************\n");
                if(!(juego->protagonista) && heap_elementos(juego->gimnasios) == 0){
                    printf(""VERDE"(E)"BLANCO"--> Ingresar el archivo del protagonista\n");
                    printf(""VERDE"(A)"BLANCO"--> Agregar gimnasio/s pokemon\n");
                    printf(""ROJO"(I)--> Comienza la partida"BLANCO"\n");
                    printf(""ROJO"(S)--> Comienza la partida en modo SIMULACION"BLANCO"\n");
                    printf("\n"ROJO"NOTA"BLANCO": Para iniciar la partida es necesario cargar un personaje y al menos un gimnasio."VERDE"* "BLANCO"\n");
                    //printf("\n"ROJO"NOTA"BLANCO": Para iniciar la partida, primero se debe ingresar el personaje y al menos 1 gimnasio.\n");
                }
                    ...
                    printf(""ROJO"(I)--> Comienza la partida"BLANCO"\n");
                    printf(""ROJO"(S)--> Comienza la partida en modo SIMULACION"BLANCO"\n");
                    printf("\n"ROJO"NOTA"BLANCO": Para iniciar la partida necesita cargar un protagonista."VERDE"* "BLANCO"\n");
                    //printf("\n"ROJO"NOTA"BLANCO": Para iniciar la partida, primero se debe ingresar el personaje.\n");
                }
                else if(heap_elementos(juego->gimnasios) == 0){
                    printf(""VERDE"(A)"BLANCO"--> Agregar gimnasio/s pokemon\n");
                    printf(""ROJO"(I)--> Comienza la partida"BLANCO"\n");
                    printf(""ROJO"(S)--> Comienza la partida en modo SIMULACION"BLANCO"\n");
                    printf("\n"ROJO"NOTA"BLANCO": Para iniciar la partida necesita cargar al menos un gimnasio."VERDE"* "BLANCO"\n");
                    //printf("\n"ROJO"NOTA"BLANCO": Para iniciar la partida, primero deber cargar al menos 1 gimnasio.\n");
                }
